 ...
 * @author MIGUEL
 */
public class DesarrolloEmpleados extends javax.swing.JFrame {
    int xMouse;
    int yMouse;   
    /**
     * Creates new form RetencionClientes
     */
    public DesarrolloEmpleados() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Desarrollo de Empleados");
        ...
        jLabel2.setText("Gastos en Desarrollo de Empleados");
        ...
        jLabel5.setText("Ingresos Netos");
    ...
    private void GraficarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GraficarActionPerformed
        try {
            ...
            chart1.addLegend("Gastos en Desarrollo de Empleados", new Color(245, 189, 135));
            chart1.addLegend("Ingresos Netos", new Color(135, 189, 245));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DesarrolloEmpleados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DesarrolloEmpleados().setVisible(true);
            }
        });
    }

 ...
 * @author MIGUEL
 */
public class CadenaSuministros extends javax.swing.JFrame {
    int xMouse;
    int yMouse;   
    /**
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Eficiencia en la Cadena de Suministros");
        ...
        jLabel2.setText("Costos de la Cadena de Suministro ");
    ...
    private void GraficarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GraficarActionPerformed
        try {
            ...
            chart1.addLegend("Costos de la Cadena de Suministro", new Color(245, 189, 135));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadenaSuministros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadenaSuministros().setVisible(true);
            }
        });
    }

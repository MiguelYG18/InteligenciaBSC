 ...
 * @author MIGUEL
 */
public class RetornoCliente extends javax.swing.JFrame {
    int xMouse;
    int yMouse;   
    /**
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Retorno del Cliente");
        ...
        jLabel2.setText("Número de Clientes que Regresan ");
        ...
        jLabel11.setText("RETORNO DEL CLIENTE:");
        ...
        jLabel13.setText("RETORNO DEL CLIENTE:");
    ...
    private void GraficarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GraficarActionPerformed
        try {
            ...
            chart1.addLegend("Número de Clientes que Regresan ", new Color(245, 189, 135));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RetornoCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RetornoCliente().setVisible(true);
            }
        });
    }

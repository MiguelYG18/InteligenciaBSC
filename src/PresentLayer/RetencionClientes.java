 ...
 * @author MIGUEL
 */
public class RetencionClientes extends javax.swing.JFrame {
    int xMouse;
    int yMouse;
    /**
     * Creates new form RetencionClientes
     */
    public RetencionClientes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tasa de Retención de Clientes");
        ...
        jLabel2.setText("Clientes al final del Período");
        ...
        jPanel4.add(txtn1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 50, 110, -1));
        jPanel4.add(txtn2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 90, 110, -1));

        jSeparator1.setBackground(new java.awt.Color(255, 0, 0));
        jSeparator1.setForeground(new java.awt.Color(255, 0, 0));
        jPanel4.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, 310, 10));

        jLabel5.setBackground(new java.awt.Color(0, 0, 0));
        jLabel5.setForeground(new java.awt.Color(255, 0, 0));
        jLabel5.setText("Nuevos Clientes Adquiridos ");
        jPanel4.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, -1, -1));

        jLabel6.setForeground(new java.awt.Color(0, 0, 0));
        jLabel6.setText("2021");
        jPanel4.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 180, -1, -1));

        jLabel7.setForeground(new java.awt.Color(0, 0, 0));
        jLabel7.setText("2022");
        jPanel4.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 230, -1, -1));
        jPanel4.add(txtm1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 180, 110, -1));
        jPanel4.add(txtm2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 230, 110, -1));

        jSeparator2.setForeground(new java.awt.Color(255, 0, 0));
        jPanel4.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 270, 310, 10));

        jLabel8.setForeground(new java.awt.Color(255, 0, 0));
        jLabel8.setText("Clientes al Inicio del Período");
        jPanel4.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 280, -1, -1));

        jLabel9.setForeground(new java.awt.Color(0, 0, 0));
        jLabel9.setText("2021");
        jPanel4.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 310, -1, -1));

        jLabel10.setForeground(new java.awt.Color(0, 0, 0));
        jLabel10.setText("2022");
        jPanel4.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 350, -1, -1));
        jPanel4.add(txtc1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 310, 110, -1));
        jPanel4.add(txtc2, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 350, 110, -1));
        ...
        jPanel4.add(Calular, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 450, -1, -1));
        ...
        jPanel4.add(Graficar, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 450, -1, -1));
        ...
        jPanel4.add(Recargar, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 500, -1, -1));
        ...
        grafica21Layout.setHorizontalGroup(
            ...
            .addGroup(grafica21Layout.createSequentialGroup()
                .addGap(22, 22, 22)
                .addComponent(chart1, javax.swing.GroupLayout.PREFERRED_SIZE, 616, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(32, Short.MAX_VALUE))
        );
        grafica21Layout.setVerticalGroup(
            grafica21Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(grafica21Layout.createSequentialGroup()
                .addComponent(chart1, javax.swing.GroupLayout.PREFERRED_SIZE, 284, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 22, Short.MAX_VALUE))
        );

        jPanel2.add(grafica21, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 30, 680, 330));
        ...
        jLabel11.setText("RETENCIÓN CLIENTES:");
        ...
        jLabel13.setText("RETENCIÓN CLIENTES:");
        ...
        jPanel2.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 370, 340, 260));
    ...
    private void GraficarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GraficarActionPerformed
        try{
            ...
            chart1.addLegend("Clientes al final del Período", new Color(245, 189, 135));
            chart1.addLegend("Nuevos Clientes Adquiridos", new Color(135, 189, 245));
            chart1.addLegend("Clientes al Inicio del Período", new Color(189, 135, 245));
            chart1.addData(new ModelChart("2021", new double[]{n1, m1,c1}));
            chart1.addData(new ModelChart("2022", new double[]{n2, m2,c2}));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RetencionClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RetencionClientes().setVisible(true);
            }
        });
    }

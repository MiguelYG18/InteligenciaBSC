 ...
 * @author MIGUEL
 */
public class RetencionConocimiento extends javax.swing.JFrame {
    int xMouse;
    int yMouse;   
    /**
     * Creates new form RetencionClientes
     */
    public RetencionConocimiento() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Retención del Conocimiento");
        ...
        jLabel2.setText("Número de Empleados que Retienen Conocimiento ");
        ...
        jLabel5.setText("Número de Empleados que Dejaron la Empresa");
        ...
        jLabel11.setText("RETENCIÓN CONOCIMIENTO");
        ...
        jLabel13.setText("RETENCIÓN CONOCIMIENTO");
    ...
    private void GraficarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GraficarActionPerformed
        try {
            ...
            chart1.addLegend("Número de Empleados que Retienen Conocimiento ", new Color(245, 189, 135));
            chart1.addLegend("Número de Empleados que Dejaron la Empresa", new Color(135, 189, 245));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RetencionConocimiento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RetencionConocimiento().setVisible(true);
            }
        });
    }

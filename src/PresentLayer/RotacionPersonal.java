 ...
 * @author MIGUEL
 */
public class RotacionPersonal extends javax.swing.JFrame {
    int xMouse;
    int yMouse;   
    /**
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Rotación Personal");
        ...
        jLabel2.setText("Número de Empleados que Dejaron la Empresa ");
        ...
        jLabel5.setText("Promedio de Empleados");
        ...
        jLabel11.setText("ROTACIÓN PERSONAL");
        ...
        jLabel13.setText("ROTACIÓN PERSONAL");
    ...
    private void GraficarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GraficarActionPerformed
        try {
            ...
            chart1.addLegend("Número de Empleados que Dejaron la Empresa", new Color(245, 189, 135));
            chart1.addLegend("Promedio de Empleados", new Color(135, 189, 245));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RotacionPersonal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RotacionPersonal().setVisible(true);
            }
        });
    }

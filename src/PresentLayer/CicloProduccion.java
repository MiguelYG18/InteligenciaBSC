 ...
 * @author MIGUEL
 */
public class CicloProduccion extends javax.swing.JFrame {
    int xMouse;
    int yMouse;   
    /**
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ciclo de Producción");
        ...
        jLabel2.setText("Tiempo de producción disponible por día");
    ...
    private void GraficarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GraficarActionPerformed
        try {
            ...
            chart1.addLegend("Tiempo de producción disponible por día", new Color(245, 189, 135));
            chart1.addLegend("Unidades requeridas por día", new Color(135, 189, 245));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CicloProduccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CicloProduccion().setVisible(true);
            }
        });
    }

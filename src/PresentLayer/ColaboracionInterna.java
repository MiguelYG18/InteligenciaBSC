 ...
 * @author MIGUEL
 */
public class ColaboracionInterna extends javax.swing.JFrame {
    int xMouse;
    int yMouse;   
    /**
     * Creates new form RetencionClientes
     */
    public ColaboracionInterna() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Colaboración Interna");
        ...
        jLabel2.setText("Horas de Colaboración Interna ");
        ...
        jLabel5.setText("Total de Horas Laborables");
        ...
        jLabel11.setText("COLABORACIÓN INTERNA");
        ...
        jLabel13.setText("COLABORACIÓN INTERNA");
    ...
    private void GraficarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GraficarActionPerformed
        try {
            ...
            chart1.addLegend("Horas de Colaboración Interna", new Color(245, 189, 135));
            chart1.addLegend("Total de Horas Laborables", new Color(135, 189, 245));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ColaboracionInterna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ColaboracionInterna().setVisible(true);
            }
        });
    }

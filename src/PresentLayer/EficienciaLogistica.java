 ...
 * @author MIGUEL
 */
public class EficienciaLogistica extends javax.swing.JFrame {
    int xMouse;
    int yMouse;   
    /**
     * Creates new form RetencionClientes
     */
    public EficienciaLogistica() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Eficiencia de Logística");
        ...
        jLabel2.setText("Costos Logísticos ");
    ...
    private void GraficarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GraficarActionPerformed
        try {
            ...
            chart1.addLegend("Costos Logísticos ", new Color(245, 189, 135));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EficienciaLogistica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EficienciaLogistica().setVisible(true);
            }
        });
    }

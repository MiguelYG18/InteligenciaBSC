 ...
 * @author MIGUEL
 */
public class EficienciaProduccion extends javax.swing.JFrame {
    int xMouse;
    int yMouse;   
    /**
     * Creates new form RetencionClientes
     */
    public EficienciaProduccion() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Eficiencia de la Producción");
        ...
        jLabel2.setText("Producción Real ");
        ...
        jLabel5.setText("Capacidad de Producción Máxima");
    ...
    private void GraficarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GraficarActionPerformed
        try {
            ...
            chart1.addLegend("Producción Real", new Color(245, 189, 135));
            chart1.addLegend("Capacidad de Producción Máxima", new Color(135, 189, 245));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EficienciaProduccion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EficienciaProduccion().setVisible(true);
            }
        });
    }

 ...
 * @author MIGUEL
 */
public class ProductividadLaboral extends javax.swing.JFrame {
    int xMouse;
    int yMouse;   
    /**
     * Creates new form RetencionClientes
     */
    public ProductividadLaboral() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Productividad Laboral");
        ...
        jLabel2.setText("Producción Total ");
    ...
    private void GraficarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GraficarActionPerformed
        try {
            ...
            chart1.addLegend("Producción Total ", new Color(245, 189, 135));
            chart1.addLegend("Número de Empleados", new Color(135, 189, 245));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductividadLaboral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductividadLaboral().setVisible(true);
            }
        });
    }

 ...
 * @author MIGUEL
 */
public class PromocionInterna extends javax.swing.JFrame {
    int xMouse;
    int yMouse;   
    /**
     * Creates new form RetencionClientes
     */
    public PromocionInterna() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Promoción Inertna");
        ...
        jLabel2.setText("Número de Promociones Internas ");
        ...
        jLabel5.setText("Total de Promociones");
        ...
        jLabel11.setText("PROMOCIÓN INTERNA");
        ...
        jLabel13.setText("PROMOCIÓN INTERNA");
    ...
    private void GraficarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GraficarActionPerformed
        try {
            ...
            chart1.addLegend("Número de Promociones Internas", new Color(245, 189, 135));
            chart1.addLegend("Total de Promociones", new Color(135, 189, 245));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PromocionInterna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PromocionInterna().setVisible(true);
            }
        });
    }

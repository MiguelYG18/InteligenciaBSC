 ...
 * @author MIGUEL
 */
public class SatisfaccionCliente extends javax.swing.JFrame {
    int xMouse;
    int yMouse;   
    /**
     * Creates new form RetencionClientes
     */
    public SatisfaccionCliente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Índice de Satisfacción del Cliente");
        ...
        jLabel2.setText("Número de Clientes Satisfechos");
        ...
        jLabel5.setText("Total de Clientes Encuestados ");
        ...
        jLabel11.setText("SASTISFACCIÓN DEL CLIENTE:");
        ...
        jLabel13.setText("SASTISFACCIÓN DEL CLIENTE:");
    ...
    private void GraficarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GraficarActionPerformed
        try {
            ...
            chart1.addLegend("Número de Clientes Satisfechos", new Color(245, 189, 135));
            chart1.addLegend("Total de Clientes Encuestados", new Color(135, 189, 245));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SatisfaccionCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SatisfaccionCliente().setVisible(true);
            }
        });
    }
